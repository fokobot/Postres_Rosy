        ...
        <form method="POST" @submit.prevent="save" novalidate  class="needs-validation">
          <div class="form-row">
            <div class="form-group col-md-12">
              <label >Nombre</label>
              <input type="text" :class="{ 'is-invalid': errores['nombre'] }" placeholder="Trabajo" class="form-control" v-model="trabajo.nombre" required>
            ...
            <div class="col-md-12">
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <input type="text" v-model="trabajo.costo" placeholder="25000"
                  class="form-control form-control-default" :class="{ 'is-invalid': errores['costo'] }">
                </div>
                <form-error :errores="errores" :campo="'costo'"></form-error>
              </div>
            </div>
          </div>
          <div class="row">
